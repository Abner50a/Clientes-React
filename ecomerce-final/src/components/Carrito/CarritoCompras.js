...
function CarritoCompras(props) {
  ...
  const [
    { GetProductos } , usuario,  {guardarProductos} , carritoCompras , {eleminarProductos} , setCarritoCompras
 ] = props.productos;
          ...
          console.log(index)
            return (
                ...
                <div className="w-20 h-10">
                  ...
                  <input type="number" id="precio_producto"  value={cantidad}  className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" name="cantidad"/>
            ...
            <p className="mb-6 italic">Informacion del costo</p>
              ...
              <a href="#">
                <button className="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none">
                  ...
                  */}
                  <span className="ml-2 mt-5px">Comprar</span> 
                </button>
              </a>
          </div>
        </div>
